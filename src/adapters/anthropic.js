...
function anthropicAdapter(client, options) {
    var _a, _b;
    if (options === void 0) { options = {}; }
    var model = (_a = options.model) !== null && _a !== void 0 ? _a : "claude-sonnet-5";
    var maxTokens = (_b = options.maxTokens) !== null && _b !== void 0 ? _b : 2000;
    return {
        complete: function (systemPrompt, userPrompt) {
